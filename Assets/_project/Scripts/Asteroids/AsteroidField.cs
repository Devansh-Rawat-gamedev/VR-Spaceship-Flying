...
public class AsteroidField : MonoBehaviour
{
    ...
    [SerializeField] List<Transform> _asteroidPrefabs;
    ...
    void SpawnAsteroids()
    {
        ...
        {
            Transform asteroid = Instantiate(_asteroidPrefabs[Random.Range(0, _asteroidPrefabs.Count)],
                _transform.position, Quaternion.identity);
            asteroid.transform.parent = _transform;
