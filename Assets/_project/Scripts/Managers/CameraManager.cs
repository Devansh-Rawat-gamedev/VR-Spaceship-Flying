...
public class CameraManager : MonoBehaviour
{
    ...
    [field:SerializeField]public Transform ActiveCamera { get; private set; }
    ...
    void Update()
    {
        ActiveCamera.SetPositionAndRotation(camCockPit.transform.position,camCockPit.transform.rotation);
